"""Disaster Recovery Agent - Domain-Specific Connectors."""
...
class TerraformCliConnector:
    """Domain-specific connector for terraform cli integration with Disaster Recovery Agent."""
...
class AwsProviderConnector:
    """Domain-specific connector for aws provider integration with Disaster Recovery Agent."""
...
class AzureProviderConnector:
    """Domain-specific connector for azure provider integration with Disaster Recovery Agent."""
...
class GcpProviderConnector:
    """Domain-specific connector for gcp provider integration with Disaster Recovery Agent."""
...
class InfracostConnector:
    """Domain-specific connector for infracost integration with Disaster Recovery Agent."""
