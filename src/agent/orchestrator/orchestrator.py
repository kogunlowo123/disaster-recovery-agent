"""Disaster Recovery Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Disaster Recovery Agent through a multi-step pipeline.
